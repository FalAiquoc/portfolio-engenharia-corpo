...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0c0e12] text-slate-100 antialiased selection:bg-[#f59e0b] selection:text-slate-950">
      ...
      {/* HEADER */}
      <header className={`fixed top-0 sm:top-18 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'bg-[#0c0e12] shadow-lg py-2 border-b border-slate-850' : 'bg-transparent py-4'}`}>
